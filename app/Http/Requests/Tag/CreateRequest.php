...
class CreateRequest extends FormRequest
{
    ...
    {
        $arrValidations = [
            'title' => 'required|max:255|unique:App\Models\Tag,title',
            'title_english' => 'required|max:255|unique:App\Models\Tag,title_english',
    ...
    public function messages()
    {
        return [
            ...
            'title_english.required' => sprintf(__('posts::messages.validate.not_empty'), __('tag::messages.title_english')),
            'title_english.max' => sprintf(__('posts::messages.validate.max'), __('tag::messages.title_english'),255),
