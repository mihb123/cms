...
class UpdateRequest extends FormRequest
{
    ...
    {
        $arrValidations = [
            'title_japan' => ['required','max:255',Rule::unique('group', 'title_japan')->whereNot('id', $this->id)->where('type', 'tag')],
            'title_english' => ['required','max:255',Rule::unique('group', 'title_english')->whereNot('id', $this->id)->where('type', 'tag')],
