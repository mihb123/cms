...
class UpdateRequest extends FormRequest
{
    ...
    {
        $arrValidations = [
            'tag_id' => 'required|numeric|exists:App\Models\Tag,id|unique:App\Models\TagNews,tag_id,' . $this->id,
    ...
    public function messages()
    {
        return [
            ...
            'creator_id.numeric' => sprintf(__('tag::messages.validate.numeric'), __('tag::messages.tag')),
