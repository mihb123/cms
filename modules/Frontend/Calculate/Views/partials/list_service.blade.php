@if (!empty($listServiceCategoryPercentage))
    <div class="acc-body" style="display: block;" >
        ...
        <div class="list-checkbox-step4">
            @foreach ($listServiceCategoryPercentage as $keyService => $serviceCategory)
                @if (!empty($serviceCategory->service) && !empty($serviceCategory['fixed_price']) && $serviceCategory['fixed_price'] == 1)
                    <div class="step4-checkbox-item style-2" data-item="monthly">
                        <input type="checkbox" name="step4[]" value="{{ !empty($serviceCategory['money']) ? $serviceCategory['money'] : 0 }}" />
                        <div class="title-with-help">
                            ...
                            <span class="text">{{ $serviceCategory->service->title ?? '' }}</span>
                                ...
                                <div class="help-popup">
                                    <div class="help-popup-body">
                                        ...
                                        <div class="help-popup-header">
                                            ...
                                            <span>{{ $serviceCategory->service->title_description ?? '' }}</span>
                                        </div>
                        ...
                        <div class="checkbox-wrap">
                            <div class="price-box2">
                                ...
                                <span class="price">{{ number_format(!empty($serviceCategory['money']) ? $serviceCategory['money'] : 0)}}</span>
