    ...
    <form action="{{ route('jigyosho.map-search') }}" method="get" id="popup-form">
      ...
      <div class="search-section">
        ...
        <div class="search-container">
          ...
          <input class="search-input-section" id="type-address" type="text" name="address_3" value=""
            placeholder="続きの住所を入力">
        </div>
      </div>
      ...
      <div class="action-section">
        <button class="action-section-btn-white" type="button" onclick="resetCategorySelect()"><span
            class="button-text">サポートの分類を修正する</span></button>
        <button class="action-section-btn-white" type="button" onclick="resetAreaSelect()"><span
            class="button-text">エリアを修正する</span></button>
        <div class="line-straight"></div>
        <a class="action-section-text-explain" href="">選択した条件で</a>
        <button class="action-section-btn-blue" type="submit"><span class="button-text">検索する <svg
              class="action-section-btn-blue-icon" xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink" width="34" height="42" viewBox="0 0 34 42">
              <defs>
              ...
              <g transform="matrix(1, 0, 0, 1, 0, 0)" filter="url(#_)">
                <text id="_2" data-name="≫" transform="translate(9 25)" fill="#fff" font-size="16"
                  font-family="SourceHanSansJP-Regular, Source Han Sans JP" letter-spacing="0.2em" opacity="0.89">
                  <tspan x="0" y="4">≫</tspan>
                </text>
              </g>
            </svg></span>
