          ...
          <div class="nav">
            ...
            <div class="box-option">
              ...
              <div class="nav-two">
                ...
                <!-- start item two  -->
                <?php //<a class="nav-item" href="https://test01.lifestar.co.jp/TopNarrow-1.php.php?search_category=訪問医師">/変更 (@ edited by a.u  2023.7.20)  ?>
                <a class="nav-item" href="../jigyosho/TopNarrow-1.php.php?search_category=訪問医師">
                  <div class="data-menu">
                ...
                <!-- start item two  -->
                <?php //<a class="nav-item" href="https://test01.lifestar.co.jp/TopNarrow-1.php.php?search_category=訪問看護師">/ 変更 (@ edited by a.u  2023.7.20)  ?>
                <a class="nav-item" href="../jigyosho/TopNarrow-1.php.php?search_category=訪問看護師">
                  <div class="data-menu">
                    <div class="nav-item__line"></div>
                    <div class="nav-item__content">
                      <p class="nav-item__content-title">
                ...
                <!-- start item two  -->
                <?php //<<a class="nav-item" href="https://test01.lifestar.co.jp/TopNarrow-1.php.php?search_category=訪問介護士"> //変更 (@ edited by a.u  2023.7.20)  ?>
