...
namespace Modules\Cms\Posts;

use Modules\Cms\Posts\Policies\PostsPolicy;
...
class Provider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'Modules\Cms\Posts\Controllers';
...
//             ->namespace($this->namespace)
    ...
    {
        Gate::resource('posts',      PostsPolicy::class);
    }
}
