...
@section('content')
<form class="kt-form" id="node-form" action="{{ route('posts-topic-category.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__body">
                    <div class="form-group">
                        ...
                        @upload(['type' => 'image', 'vendor' => 'postsTopicCategory', 'value' => old('avatar') ?? '' , 'thumb' => old('thumb-avatar') ?? '','name' => 'avatar'])
                    </div>
                </div>
            </div>
            <div class="kt-portlet">
