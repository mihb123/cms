...
@section('title', __('posts::messages.manage.posts-title'))
    ...
    <div class="kt-portlet__head kt-portlet__head--lg">
        <div class="kt-portlet__head-label">
            <span class="kt-portlet__head-icon">
                <i class="kt-font-brand flaticon2-posts"></i>
            </span>
            <h3 class="kt-portlet__head-title">
                {{ __('posts::messages.manage.posts-title') }}
            </h3>
        </div>
            ...
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions">
                    <a href="{{ route('posts.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
                        ...
                        @lang('posts::messages.create_new')
                    </a>
                </div>
            </div>
        </div>
