...
@section('content')
    <form class="kt-form" id="node-form" action="{{ route('creator.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-9">
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" placeholder="@lang('ご入力をお願いします。')" value="{{ old('name') }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" style="height:100px" name="summary" placeholder="{{ __('ご入力をお願いします。') }}" cols="30"rows="3">{{ old('summary') }}</textarea>
                        </div>
                        <div class="form-group">
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                         <div class="form-group">
                            ...
                            @upload(['type' => 'image', 'vendor' => 'creator', 'name' => 'avatar'])
                        </div>
                    </div>
                </div>
                <div class="kt-portlet">
