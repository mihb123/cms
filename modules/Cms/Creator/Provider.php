...
namespace Modules\Cms\Creator;

use Modules\Cms\Creator\Policies\CreatorPolicy;
...
class Provider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'Modules\Cms\Creator\Controllers';
...
//             ->namespace($this->namespace)
    ...
    {
        Gate::resource('creator',      CreatorPolicy::class);
    }
}
