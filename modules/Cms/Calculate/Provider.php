...
namespace Modules\Cms\Calculate;

use Modules\Cms\Calculate\Policies\CalculatePolicy;
...
class Provider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'Modules\Cms\Calculate\Controllers';
...
//             ->namespace($this->namespace)
    ...
    {
        Gate::resource('calculate',      CalculatePolicy::class);
    }
}
