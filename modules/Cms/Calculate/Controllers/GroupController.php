...
use App\Http\Requests\CalculateGroup\CreateRequest;
use App\Http\Requests\CalculateGroup\UpdateRequest;
...
class GroupController extends Controller
{
    ...
    {
        return view('calculate::group.index');
    }

    public function create()
    {
        return view('calculate::group.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('calculate::group.edit', compact('group'));
    }
    ...
    {
        return $this->groupService->getAjaxCalculate($request);
    }
