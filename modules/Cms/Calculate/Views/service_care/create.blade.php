...
@section('content')
    <form class="kt-form" id="node-form" action="{{ route('calculate-service-care.store') }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-9">
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title_description" placeholder="@lang('タイトルを入力お願いします。')" value="{{ old('title_description') }}">
                        </div>
                        <div class="form-group">
                            <label class="required">{{ __('calculate::messages.description') }}</label>
                            <textarea class="summernote" name="description" placeholder="備考" cols="30" rows="3">{!! old('description') !!}</textarea>
                        </div>
                        <div class="form-group">
