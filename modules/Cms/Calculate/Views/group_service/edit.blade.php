...
@section('content')
<form class="kt-form" id="node-form" action="{{  route('calculate-service-group.update', $group['id']) }}" method="POST">
    @csrf
    @method('PUT')
                ...
                <div class="kt-portlet__body">
                    <div class="form-group">
                        <div class="col-md-12 fvalue">
                            <a class="btn btn-dark" href="{{ route('calculate-service-group.index') }}">
