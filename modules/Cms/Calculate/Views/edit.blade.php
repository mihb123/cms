            ...
            <div class="col-md-9">
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group">
                            <label class="required">タググループ</label>
                        ...
                        <div class="form-group">
                            <label class="required">{{ __('投稿 グループ') }}</label>
                            <select class="form-control status" data-placeholder="{{ __('投稿 グループ') }}" name="group_id">
                                <option selected>{{ __('選択してください') }}</option>
                                @foreach($listGroup as $value => $group)
                                    <option
                                        {{ ($post['group_id'] == $group->id) ? 'selected' : '' }} value="{{ $group->id }}">{{ $group->title_japan }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
