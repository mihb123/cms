...
@section('content')
    <form class="kt-form" id="node-form" action="{{ route('percentage-burden.update', $data['id']) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="percentage" placeholder="@lang('入力をお願いします。')" value="{{ $data['percentage'] }}">
                        </div>               
                        <div class="form-group">
