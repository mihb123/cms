...
namespace Modules\Cms\KeyWords;

use Modules\Cms\KeyWords\Policies\KeyWordsPolicy;
...
class Provider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'Modules\Cms\KeyWords\Controllers';
...
//             ->namespace($this->namespace)
    ...
    {
        Gate::resource('key-words',      KeyWordsPolicy::class);
    }
}
