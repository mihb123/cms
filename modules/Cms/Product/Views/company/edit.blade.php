...
@section('content')
    <form class="kt-form" id="node-form" action="{{ route('company.update', $data['id']) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" type="text" name="name" placeholder="@lang('入力をお願います')" value="{{ $data['name'] }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <textarea class="form-control" type="text" name="summary" style="height: 300px" placeholder="@lang('記述を入力お願いします。')">{{ $data['summary'] }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <div class="input-group w-25">
                                        <input class="form-control" id="postcode" type="text" name="zip" placeholder="@lang('郵便番号を入力')" value="{{ $data['zip'] }}">
                                        <div class="input-group-append">
                                            <button class="btn btn-primary" type="button" id="btn-zip">検索</button>
                                        </div>
                                    </div>
                                    <input class="form-control mt-2" id="province" type="text" name="province" readonly value="{{ $data['province'] }}">
                                    <input class="form-control mt-2" name="city" value="{{ $data['city'] }}" readonly id="city">
                                    <input class="form-control mt-2" name="address" value="{{ $data['address'] }}" id="address">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <select multiple class="form-control status" data-placeholder="{{ __('選択してください') }}" name="category_id[]">
                                        <option >{{ __('選択してください') }}</option>
                                        @foreach($listCategory as $value => $category)
                                            <option {{ in_array($category['id'], $categoryIds) ? 'selected' : '' }} value="{{ $category->id }}">{{ $category->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-10">
                                    <select multiple class="form-control status" data-placeholder="{{ __('product::messages.service') }}" name="service_id[]">
                                        ...
                                        @foreach($listService as $value => $service)
                                            <option {{ in_array($service['id'], $serviceIds) ? 'selected' : '' }} value="{{ $service->id }}">{{ $service->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" type="text" name="url_home_page" placeholder="@lang('product::messages.url_home_page')" value="{{ $data['url_home_page'] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" type="text" name="url_info" placeholder="@lang('product::messages.url_info')" value="{{ $data['url_info'] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <?php /*
