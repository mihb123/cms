...
@section('content')
<form class="kt-form" id="node-form" action="{{ route('factory.update', $data['id']) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" type="text" name="description" placeholder="@lang('記述を入力お願いします。')">{{ $data['description'] }}</textarea>
                    </div>
                    <div class="form-group">
            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__body">
                    <div class="form-group">
                        ...
                        @upload(['type' => 'image', 'vendor' => 'factory', 'name' => 'avatar', 'value' => isset($data['avatar']->id) ? $data['avatar']->id : '' , 'thumb' => isset($data['avatar']->path) ? thumb($data['avatar']->path) : '' ])
                    </div>
                    <div class="form-group">
                        <label>URL</label>
                        <input class="form-control title-english" type="text" name="url_image" value="{{ $data['url_image'] ?? '' }}">
                    </div>
                    <div class="form-group">
                        <label>幅</label>
                        <input class="form-control title-english" type="text" name="width_image" value="{{ $data['width_image'] ?? '' }}">
                    </div>
                    <div class="form-group">
                        <label>高さ</label>
                        <input class="form-control title-english" type="text" name="height_image" value="{{ $data['height_image'] ?? '' }}">
                    </div>
                </div>
            </div>
