        ...
        <div class="kt-portlet__head-toolbar">
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions">
                    <a href="{{ route('product-option.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
        ...
        <table class="table table-striped- table-bordered table-hover table-checkable" id="example">
            <thead>
                <tr>
                    ...
                    <th>{{ __('product::messages.manage.product-title') }}</th>
                    <th>{{ __('product::messages.category') }}</th>
                    <th>{{ __('product::messages.note_option') }}</th>
...
<script>
    $(function() {
        ...
        var table = $("#example").DataTable({
            ...
            ajax: {
                type: 'GET',
                url: cedu.route('/product-option/ajax'),
                data: (data) => {
                    data.tab = filter;
                }
            },
