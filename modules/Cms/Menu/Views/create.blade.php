    ...
    <div class="col-lg-3">
        <div class="kt-portlet ">
            ...
            <div class="kt-portlet__body">
                <form class="kt-form" id="node-form" action="{{ route('menu.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                    ...
                                    <div class="kt-checkbox-list">
                                        @foreach ($listCategoryTag as $key => $categoryTag)
                                            <label class="kt-checkbox kt-checkbox--success">
                                                <input type="checkbox" name="menus[]" value="{{ $categoryTag['id']}}"> {!! $categoryTag['title'] ?? ''!!}
                                                <span></span>
                                            </label>
                                        @endforeach
                                    </div>
