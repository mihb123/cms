...
namespace Modules\Cms\SiteMap;

use Modules\Cms\SiteMap\Policies\SiteMapPolicy;
use Modules\Cms\Tag\Policies\TagPolicy;
...
class Provider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'Modules\Cms\SiteMap\Controllers';
...
//             ->namespace($this->namespace)
    ...
    {
        Gate::resource('sitemap',      SiteMapPolicy::class);
    }
}
