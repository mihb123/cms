...
@section('content')
    <form class="kt-form row" id="node-form" action="{{ route('family-member-news.store') }}" method="POST">
        @csrf
        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="title" class="form-control" value="{{ old('title') }}" placeholder="{{ __('こちらにタイトルを入力') }}" />
                            </div>
                            <div class="col-md-6">
                                <label>カテゴリー</label>
                                <select class="form-control status" data-placeholder="選択してください" name="family_member_category_id">
                                    ...
                                    @foreach($listCategory as $key => $category)
                                        <option {{ (old('family_member_category_id') == $category['id']) ? 'selected' : '' }} value="{{ $category['id'] }}">{{ $category['title'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select class="form-control status" data-placeholder="選択してください" name="family_member_id">
                                    <option value="" selected>{{ __('選択してください') }}</option>
                                    @foreach($listfamilyMember as $key => $familyMember)
                                        <option {{ (old('family_member_id') == $familyMember['id']) ? 'selected' : '' }} value="{{ $familyMember['id'] }}">{{ $familyMember['name'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="patient_relationship" class="form-control" value="{{ old('patient_relationship') }}" placeholder="{{ __('こちらに入力してください') }}" />
                            </div>
                            <div class="col-md-6">
                                <label class="required">家族関係(英語)</label>
                                <input type="text" name="patient_relationship_en" class="form-control" value="{{ old('patient_relationship_en') }}" placeholder="{{ __('英語でこちらに入力してください') }}" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="treatment_place" class="form-control" value="{{ old('treatment_place') }}" placeholder="{{ __('こちらに入力してください') }}" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-4 input-group">
                                        <input type="text" name="disease_year_start" style="width: 80%;display: inline" class="form-control" value="{{ old('disease_year_start') }}" />
                                        <div class="input-group-append"><span class="input-group-text" id="basic-addon1">年</span></div>
                                    </div>
                                    <div class="col-md-4 input-group">
                                        <input type="text" name="disease_month_start" style="width: 80%;display: inline" class="form-control" value="{{ old('disease_month_start') }}" />
                                        <div class="input-group-append"><span class="input-group-text" id="basic-addon1">ヶ月</span></div>
                                    </div>
                                    <div class="col-md-4 input-group">
                                        <input type="text" name="disease_day_start" style="width: 80%;display: inline" class="form-control" value="{{ old('disease_day_start') }}" />
            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__body">
                    <div class="form-group">
                        ...
                        @upload(['type' => 'image', 'vendor' => 'family-member-news', 'value' => old('avatar') ?? '' , 'thumb' => old('thumb-avatar') ?? '','name' => 'avatar'])
                    </div>
                </div>
            </div>
            <div class="kt-portlet">
