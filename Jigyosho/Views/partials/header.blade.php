        ...
        <div class="box-menu">
          ...
          <div class="menu">
            ...
            <a href="/" class="menu__logo">
              ...
              <img class="pc doctor-icon" src="{{ asset('frontend/jigyosho/issets/images/illust-docter.svg') }}"
            ...
            <div class="menu-btn">
              <div class="menu-btn__hamburgers">
                <img src="{{ asset('frontend/jigyosho/issets/images/icon_nav/nav-humberger-pink.svg') }}"
                  alt="Hamburger Icon" />
                <p class="menu-btn__hamburgers-text">Menu</p>
                <div class="menu-btn__hamburgers-arrow">
                  <img src="{{ asset('frontend/jigyosho/issets/images/icon_menu/arrow-right.svg') }}"
                    alt="Arrow Right" />
                </div>
              </div>
            </div>
                ...
                <div class="nav-option">
                  <div class="nav-option-left">
                    <div class="nav-option-left__img">
                      <img src="{{ asset('frontend/jigyosho/issets/images/icon_nav/support.svg') }}"
                        alt="Support Icon" />
                    </div>
                    <p class="nav-option-left__text--blue">User's Guide</p>
                  </div>
                  <div class="nav-option-right">
                    <a href="../info/guide.php">
                  ...
                  @php
                    $menuItems = [
                        [
                            ...
                            'title' => '医師',
                            'subtitle' => '訪問',
                            'detail' => 'Home Health Care Doctors',
                        ...
                        [
                            ...
                            'title' => '入浴',
                            'subtitle' => '訪問',
                            'detail' => 'Home-visit Bathing',
                            'icon' => 'Home-visit Bathing.svg',
                        ],
                        [
                            'url' => '公共の相談所',
                            'title' => '公共相談所',
                            'subtitle' => '介護の',
                            'detail' => 'Home Care Counseling Center',
                            'icon' => 'Home-Care-Counseling-Center.svg',
                        ],
                        [
                            'url' => '専門相談員（無料）',
                            'title' => '専門相談員',
                            'subtitle' => '介護の',
                            'detail' => 'Care manager',
                            'icon' => 'Care-manager.svg',
                        ],
                        [
                            'url' => '訪問リハビリ',
                            'title' => 'リハビリ',
                            'subtitle' => '訪問',
                            'detail' => 'Home Visits Rehabilitation',
                            'icon' => 'Home-Visits-Rehabilitation.svg',
                        ],
                        [
                            'url' => '福祉用具（ベッド他）',
                            'title' => '福祉用具',
                            'subtitle' => '（レンタル）<br>（販売）',
                            'detail' => 'Assistive products',
                            'icon' => 'Assistive-products.svg',
                        ],
                        [
                            'url' => '訪問薬局',
                            'title' => '薬局',
                            'subtitle' => '訪問',
                            'detail' => 'Home-visit pharmacy',
                            'icon' => 'Home-visit pharmacy.svg',
                        ],
                        [
                            'url' => 'あん摩・鍼灸',
                            'title' => 'あん摩・鍼灸',
                            'subtitle' => '',
                            'detail' => 'Masseuse, Acupuncture and Moxibustion',
                            'icon' => 'Masseuse-Acupuncture-and-Moxibustion.svg',
                        ],
                        [
                            'url' => '夜間対応訪問介護',
                            'title' => '介護',
                            'subtitle' => '夜間対応型 訪問',
                            'detail' => 'Nighttime home-visit care',
                            'icon' => 'Nighttime-home-visit-care.svg',
                        ],
                        [
                            'url' => '定期巡回',
                            'title' => '看護 介護',
                            'subtitle' => '定期巡回・随時対応 訪問',
                            'detail' => 'Routine home care and nursing care',
                            'icon' => 'Routine-home-care-and-nursing-care.svg',
                        ],
                    ];
                  @endphp

                  @foreach ($menuItems as $item)
                    <button class="nav-item" data-url="{{ $item['url'] }}">
                      <div class="data-menu">
                      ...
                      <div class="nav-item__icon">
                        <img src="{{ asset("frontend/jigyosho/issets/images/icon_nav/{$item['icon']}") }}"
                          alt="{{ $item['detail'] }}" />
                      </div>
                    </button>
                  @endforeach
