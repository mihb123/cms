...
<head>
  ...
  <link rel="stylesheet"
    href="{{ asset('frontend/jigyosho/issets/library/owlcarousel/assets/owl.theme.default.min.css') }}" />
  <link rel="stylesheet"
    href="{{ asset('frontend/jigyosho/issets/library/owlcarousel/assets/owl.carousel.min.css') }}" />
