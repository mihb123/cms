...
return [
    ...
    */
    ...
    'numeric'              => '必須項目です。必ず指定してください。',
    'password'             => '正しいパスワードを指定してください。',
    'present'              => ':attributeが存在していません。',
    'regex'                => ':attributeに正しい形式を指定してください。',
    'required'             => '必須項目です。必ず指定してください。',
    ...
    */
    ...
    'payment' => [
        'number' => 'カード番号が間違っています。',
        'exp_month' => 'カードの有効期限月が無効です。',
        'exp_year' => 'カードの有効期限が無効です。',
        'cvc' => 'カードのセキュリティ コードが無効です。'
    ]
