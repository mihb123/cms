...
class CreateSwmsMhlwDtlOffcInfo13Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('swms_mhlw_dtl_offc_info_13', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('swms_mhlw_dtl_offc_info_13');
    }
};
