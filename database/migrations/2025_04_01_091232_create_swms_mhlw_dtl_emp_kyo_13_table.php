...
class CreateSwmsMhlwDtlEmpKyo13Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('swms_mhlw_dtl_emp_kyo_13', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('swms_mhlw_dtl_emp_kyo_13');
    }
};
