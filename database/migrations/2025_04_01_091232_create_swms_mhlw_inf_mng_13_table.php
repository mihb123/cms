...
class CreateSwmsMhlwInfMng13Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('swms_mhlw_inf_mng_13', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('swms_mhlw_inf_mng_13');
    }
};
