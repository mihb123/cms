...
class CreateSwmsMhlwMngSvcQuaEffr13Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('swms_mhlw_mng_svc_qua_effr_13', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('swms_mhlw_mng_svc_qua_effr_13');
    }
};
