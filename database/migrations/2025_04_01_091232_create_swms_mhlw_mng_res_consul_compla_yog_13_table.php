...
class CreateSwmsMhlwMngResConsulComplaYog13Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('swms_mhlw_mng_res_consul_compla_yog_13', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('swms_mhlw_mng_res_consul_compla_yog_13');
    }
};
