...
class CreateSwmsMhlwMngUserRghtPrtctKyo13Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('swms_mhlw_mng_user_rght_prtct_kyo_13', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('swms_mhlw_mng_user_rght_prtct_kyo_13');
    }
};
