...
$from = "t.customer@personallife.co.jp";
...
//リファラチェックを「する」場合のドメイン ※設置するサイトのドメインを指定しyokkaichiて下さい。
//もしこの設定が間違っている場合は送信テストですぐに気付けます。
$Referer_check_domain = "lifestar.co.jp";
...
$subject = "≪公式- Life Star.co.jp≫サイトからお問合せがありました。";
...
$refrom_name = "公式- Life Star.co.jp";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "≪公式- Life Star.co.jp≫お問い合わせありがとうございます";
...
//自動返信メールの後半の文言 ※日本語部分のみ変更可
$remail_text = <<< TEXT

このたびは、Life Star.co.jpへお問い合わせ頂き誠にありがとうございます。

ご入力頂いたメールアドレスへ、自動返信の確認メールをお送りしております。

お問い合わせの内容を確認の上、24h以内に折り返しご連絡させて頂きます。

なお、24h経ってもご返信が届かない場合には、ご入力頂いたメールアドレスが間違っているか、

迷惑メールフォルダに振り分けられている可能性がございます。

つきまして大変お手数ではございますが、「@personallife.co.jp」からのメール受信ができるよう

ご設定を頂き再度お試し頂くようお願い申し上げます。
TEXT;
...
function mailToAdmin($arr,$subject,$mailFooterDsp,$mailSignature,$encode,$confirmDsp){
    $remail_tex_admin = <<< TEXT
    
    お客様がLife Starにご入力いただいた内容は以下の通りです。

    ご確認くださいます様お願い申し上げます。\n
    TEXT;
    $adminBody = "";
    $adminBody.= $remail_tex_admin;
    $adminBody.="━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n";
    ...
    // if($confirmDsp != 1){
    // 	$adminBody.="送信元URL：".@$_SERVER['HTTP_REFERER']."\n";
    // }else{
    // 	$adminBody.="送信元URL：".@$arr['httpReferer']."\n";
    // }
