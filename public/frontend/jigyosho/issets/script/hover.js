...
$('.banner-form-select ').click(function (e) {
  if (e.target == this) {
    ...
    $('#datalist-input').removeAttr('disabled');
  }
});
...
$(document).ready(function(){
  $('.banner-checkbox-item').on('change',function(e){
    $(this).closest('.banner-checkboxs__item').siblings().find('input[type="checkbox"]').prop('checked',false);;
  });
});
// $(document).ready(function(){
//   $('.option-address__checkboxs-item').on('change',function(e){
//     $(this).closest('.option-address__checkboxs-item').siblings().find('input[type="checkbox"]').prop('checked',false);;
//   });
// });
$(document).ready(function(){
  $('.option-address__checkboxs-item input').on('change',function(e){
    $(this).closest('.option-address__col').siblings().find('input[type="checkbox"]').prop('checked',false);
    $(this).closest('.option-address__checkboxs-item').siblings().find('input[type="checkbox"]').prop('checked',false);
    $(this).closest('.option-address__toggle').siblings().find('input[type="checkbox"]').prop('checked',false);
    if($(this).is(':checked')){
      $(this).closest('.option-address__check-box').find(".select-round").removeClass('disabled');
    }else{
      $(this).closest('.option-address__check-box').find(".select-round").addClass('disabled');
    }
  });
});
...
$(".s-sp-more").on("click", function (e) {
  e.preventDefault();
  $(this).remove();
  $(".s-sp-item.hide-mb").show();
})